...
<div id="affwp-affiliate-dashboard-referrals" class="affwp-tab-content">
	...
	<table id="affwp-affiliate-dashboard-referrals" class="affwp-table affwp-table-responsive">
		<thead>
			<tr>
				<th class="referral-amount"><?php _e( 'Name', 'affiliate-wp' ); ?></th>
              	<th class="referral-amount"><?php _e( 'Campaign', 'affiliate-wp' ); ?></th>
		...
		<tbody>
			<?php if ( $referrals ) : ?>
				...
				<?php foreach ( $referrals as $referral ) : ?>
					<tr>
						<td class="referral-reference" data-th="<?php _e( 'Name', 'affiliate-wp' ); ?>">
                          
                          <?php  
					 	$cus_ob = affwp_get_customer($referral->customer_id) ;
						echo esc_html( $cus_ob->first_name ) ." ". esc_html( $cus_ob->last_name ) ; 

                          ?>
                      
                      </td>
                      
                      	<td class="referral-reference" data-th="<?php _e( 'Campaign', 'affiliate-wp' ); ?>">
                          
                          <?php echo esc_html( $referral->campaign );
                          ?>
